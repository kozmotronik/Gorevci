...
# Amaç
Başta küçük ölçekli gömülü sistemler olmak üzere farklı gömülü sistemler üzerinde çalışabilecek ANSI C ile yazılmış görev organizasyonu yapan bir uygulama geliştirmek.
...
## Genel Özellikler
- Çok küçük miktarda RAM kullanır. Her bir *Görev Kontrol Bloğu* için *Normal kip*te 2 word, *Hafif kip*te ise yalnızca 1 word gerekir ve extra yığınlar (thread stack) kullanılmaz<sup id="a2">[2](#fn2)</sup>.
...
| :---		| :----:   			| :---:			| :---:			|
| ROM		| Program belleği	| 250 word		| 6 word			|
| RAM		| Sistem belleği		| 23 word      	| 1 word      	|
| Stack		| Donanım stack		| 7 düzey      	| 5 düzey		|
| Tik Timer	| Timer donanım		| 1 Adet      	||

Görüldüğü gibi *Normal kip*te Görevcinin görev yönetim mekanizması da derlendiği için 250 word<sup id="a5">[5](#fn5)</sup> kadar program belleğine, 23 word kadar da RAM belleğine gerek duyar. Ancak hafif kipte görev yönetimini doğrudan programcı üstlendiğinden yalnızca 6 word ROM ve 1 word RAM gibi oldukça az kaynak ister.
...
24 ve üzeri görev sayısı için *Normal kip*te harcanacak **RAM** şöyle hesaplanır:
`Görev sayısı x 3 + 6`.
