...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
 ...
 for(;;){
  ...
  ( (gorev_t*) tutucu )->sn = 224; case 224:; if(((ADCON0bits.GO))){ return 0; };
  ...
  ( (sure_t*) &s4 )->kacTik = (500u / (1000u / 1000u)); ( (sure_t*) &s4 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 241; case 241:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s4 )->baslangic) >= ( (sure_t*) &s4 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 244; case 244: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char gostergeDegeriHesapla(gorevTutucu_t tutucu){
 ...
 while(1){
  ...
  ( (gorev_t*) tutucu )->sn = 251; case 251:; if(!(icerik == 20)){ return 0; };
  ( (gorev_t*) tutucu )->sn = 252; case 252:; if(!(karasimsekHiziOkundu == 1)){ return 0; };
  karasimsekHiziOkundu = 0;
  karasimsekGostergeDegeri = (uint8_t) (gercekDeger / (uint8_t) ((1024u - 50u) / (7u - 0u)));
  icerikDegisti = 1;
 }
 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 257; case 257: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
# 270 "ornek2.c"
 ...
 while(1){
  ( (gorev_t*) tutucu )->sn = 279; case 279:; if(!(icerikDegisti == 1)){ return 0; };
  icerikDegisti = 0;
  if(icerik == 10){
   LATD = karasimsek;
  } else if(icerik == 20){
 ...
 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 297; case 297: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char icerikDegistirici(gorevTutucu_t tutucu){
 ...
 while(1){
  ( (gorev_t*) tutucu )->sn = 311; case 311:; if(!(PORTBbits.RB4 == 0)){ return 0; };
  ( (sure_t*) &s5 )->kacTik = (100u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 312; case 312:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
  ...
  ( (gorev_t*) tutucu )->sn = 322; case 322:; if((PORTBbits.RB4 == 0)){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 325; case 325: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
void main(void) {
 ...
 INTCONbits.GIEH = 1;;
    ...
    while(1) {
        ...
        gostergeDegeriHesapla(&gdh);
        icerikGuncelleyici(&ig);
        icerikDegistirici(&id);
    }
