...
char uretici1(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) (tutucu) )->sn = 54; case 54:; if(!(!(uckuyrukDolu(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 56; case 56:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk1, veri1, 4) < 0))){ return 0; };

        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 58; case 58:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 61; case 61: return 2; } return 1;
}
...
char uretici2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) (tutucu) )->sn = 71; case 71:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 73; case 73:; if(!(!(uckuyrukCokluAl(&kuyruk1, veri2, 4) < 0))){ return 0; };

        for(int s = 0; s < 4; s++) {
            veri2[s] = veri2[s] + 10;
        }

        ( (gorev_t*) (tutucu) )->sn = 79; case 79:; if(!(!(uckuyrukDolu(&kuyruk2)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 81; case 81:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk2, veri2, 4) < 0))){ return 0; };

        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 83; case 83:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 86; case 86: return 2; } return 1;
}
...
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) (tutucu) )->sn = 95; case 95:; if(!(!(uckuyrukBos(&kuyruk2)))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (500 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 116; case 116:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 118; case 118: return 2; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 156; case 156:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 163; case 163:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 171; case 171:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
