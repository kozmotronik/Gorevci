...
# 152 "../../../../../kaynak/include/uckuyruk.h"
char uckuyrukKuyrukla(uckuyruk_t*, const unsigned char);
# 168 "../../../../../kaynak/include/uckuyruk.h"
...
# 237 "../../../../../kaynak/include/uckuyruk.h"
char uckuyrukDolu(uckuyruk_t*);
# 248 "../../../../../kaynak/include/uckuyruk.h"
unsigned char uckuyrukKalanKapasite(uckuyruk_t*);
# 259 "../../../../../kaynak/include/uckuyruk.h"
...
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) (tutucu) )->sn = 119; case 119:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (500 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 140; case 140:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 142; case 142: return 2; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 179; case 179:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 186; case 186:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 194; case 194:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 202; case 202:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 207; case 207: return 2; } return 1;
}
