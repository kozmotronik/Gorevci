...
char uretici1(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        do{ ( (gorev_t*) tutucu )->sn = 62; case 62:; if(!((&kuyruk1Erisim)->sayim > 0)){ return 0; }; --(&kuyruk1Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 64; case 64:; if(!(!(uckuyrukDolu(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 66; case 66:; if(!(!(uckuyrukKuyrukla(&kuyruk1, cift) == 0))){ return 0; };
        ...
        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 75; case 75:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 78; case 78: return 2; } return 1;
}
...
char uretici2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        do{ ( (gorev_t*) tutucu )->sn = 94; case 94:; if(!((&kuyruk1Erisim)->sayim > 0)){ return 0; }; --(&kuyruk1Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 96; case 96:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 98; case 98:; if(!(!(uckuyrukKuyrukla(&kuyruk1, tek) == 0))){ return 0; };
        ...
        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 107; case 107:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 110; case 110: return 2; } return 1;
}
# 120 "ornek4.c"
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) (tutucu) )->sn = 126; case 126:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (500 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 147; case 147:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 149; case 149: return 2; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 191; case 191:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 198; case 198:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 206; case 206:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 214; case 214:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 219; case 219: return 2; } return 1;
}
