...
char uretici1(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        do{ ( (gorev_t*) tutucu )->sn = 59; case 59:; if(!((&kuyruk1Erisim)->sayim > 0)){ return 0; }; --(&kuyruk1Erisim)->sayim; } while(0);

        ( (gorev_t*) tutucu )->sn = 61; case 61:; if((uckuyrukDolu(&kuyruk1))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 63; case 63:; if((uckuyrukKuyrukla(&kuyruk1, cift) == 0)){ return 0; };
        ...
        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 72; case 72:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 75; case 75: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char uretici2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        do{ ( (gorev_t*) tutucu )->sn = 91; case 91:; if(!((&kuyruk1Erisim)->sayim > 0)){ return 0; }; --(&kuyruk1Erisim)->sayim; } while(0);

        ( (gorev_t*) tutucu )->sn = 93; case 93:; if((uckuyrukBos(&kuyruk1))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 95; case 95:; if((uckuyrukKuyrukla(&kuyruk1, tek) == 0)){ return 0; };
        ...
        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 104; case 104:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 107; case 107: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
# 117 "ornek4.c"
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) tutucu )->sn = 123; case 123:; if((uckuyrukBos(&kuyruk1))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (500 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 144; case 144:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 146; case 146: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 188; case 188:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 195; case 195:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 203; case 203:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 211; case 211:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 216; case 216: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
