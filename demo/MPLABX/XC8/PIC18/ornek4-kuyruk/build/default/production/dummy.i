...
char uretici1(gorevTutucu_t tutucu) {
    ...
    const unsigned char veri1[] = { 23, 34, 54, 87 };

 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;

    for(;;) {

        ( (gorev_t*) (tutucu) )->sn = 57; case 57:; if(!(!(uckuyrukDolu(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 59; case 59:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk1, veri1, 4) == 0))){ return 0; };


        do{ ( (gorev_t*) tutucu )->sn = 62; case 62:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 64; case 64:; if(!(!(uckuyrukDolu(&kuyruk2)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 66; case 66:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk2, veri1, 4) == 0))){ return 0; };
 ...
 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 75; case 75: return 2; } return 1;
}
...
char uretici2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) (tutucu) )->sn = 85; case 85:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 87; case 87:; if(!(!(uckuyrukCokluAl(&kuyruk1, veri2, 4) == 0))){ return 0; };
        ...
        do{ ( (gorev_t*) tutucu )->sn = 94; case 94:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 96; case 96:; if(!(!(uckuyrukDolu(&kuyruk2)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 98; case 98:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk2, veri2, 4) == 0))){ return 0; };
 ...
 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 107; case 107: return 2; } return 1;
}
...
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) (tutucu) )->sn = 116; case 116:; if(!(!(uckuyrukBos(&kuyruk2)))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (1000 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 137; case 137:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 139; case 139: return 2; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 177; case 177:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 184; case 184:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 192; case 192:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 200; case 200:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 205; case 205: return 2; } return 1;
}
