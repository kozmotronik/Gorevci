...
# 28 "../../../../../kaynak/portlar/mplabx/xc8/pic18/port.h"
# 1 "./gorevciypl.h" 1
# 29 "../../../../../kaynak/portlar/mplabx/xc8/pic18/port.h" 2
...
# 30 "../../../../../kaynak/portlar/mplabx/xc8/pic18/port.h" 2
...
char ledCakarlama1(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 90; case 90:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

        PORTEbits.RE1 = !PORTEbits.RE1;

        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 94; case 94:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 98; case 98: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char ledCakarlama2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
  ...
  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 120; case 120:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTEbits.RE2 = !PORTEbits.RE2;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 124; case 124:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTEbits.RE2 = !PORTEbits.RE2;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 128; case 128:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTEbits.RE2 = !PORTEbits.RE2;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 132; case 132:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
  ...
  ( (sure_t*) &s2 )->kacTik = (1000u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 140; case 140:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 143; case 143: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char karaSimsek(gorevTutucu_t tutucu) {
 ...
 for(;;) {
  ...
  ( (sure_t*) &s3 )->kacTik = (karaSimsekHizi / (1000u / 1000u)); ( (sure_t*) &s3 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 181; case 181:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s3 )->baslangic) >= ( (sure_t*) &s3 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 184; case 184: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
    ...
    for(;;){
        ...
        ( (gorev_t*) tutucu )->sn = 209; case 209:; if(((ADCON0bits.GO))){ return 0; };
        ...
        ( (sure_t*) &s4 )->kacTik = (300u / (1000u / 1000u)); ( (sure_t*) &s4 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 228; case 228:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s4 )->baslangic) >= ( (sure_t*) &s4 )->kacTik ))){ return 0; };
    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 231; case 231: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
# 252 "ornek3.c"
    char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    while(1){
        ( (gorev_t*) tutucu )->sn = 254; case 254:; if(!(karasimsekHiziOkundu == 1)){ return 0; };
        karasimsekHiziOkundu = 0;

        uint16_t olcekliDeger = (uint16_t) (gercekDeger / (uint8_t) ((1024u - 0u) / (214u - 10u)));
    ...
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 279; case 279: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char gostergeGuncelle(gorevTutucu_t tutucu){
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 320; case 320:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 327; case 327:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 335; case 335:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 343; case 343:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 348; case 348: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
