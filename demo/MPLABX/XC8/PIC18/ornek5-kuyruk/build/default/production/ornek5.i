...
char uretici1(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) (tutucu) )->sn = 64; case 64:; if(!(!(uckuyrukDolu(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 66; case 66:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk1, veri1, 4) == 0))){ return 0; };


        do{ ( (gorev_t*) tutucu )->sn = 69; case 69:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 71; case 71:; if(!(!(uckuyrukDolu(&kuyruk2)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 73; case 73:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk2, veri1, 4) == 0))){ return 0; };


        ++(&kuyruk2Erisim)->sayim;;


        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 79; case 79:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 82; case 82: return 2; } return 1;
}
# 94 "ornek5.c"
char uretici2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) (tutucu) )->sn = 101; case 101:; if(!(!(uckuyrukBos(&kuyruk1)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 103; case 103:; if(!(!(uckuyrukCokluAl(&kuyruk1, veri2, 4) == 0))){ return 0; };
        ...
        do{ ( (gorev_t*) tutucu )->sn = 110; case 110:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) (tutucu) )->sn = 112; case 112:; if(!(!(uckuyrukDolu(&kuyruk2)))){ return 0; };

        ( (gorev_t*) (tutucu) )->sn = 114; case 114:; if(!(!(uckuyrukCokluKuyrukla(&kuyruk2, veri2, 4) == 0))){ return 0; };


        ++(&kuyruk2Erisim)->sayim;;


        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 120; case 120:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 123; case 123: return 2; } return 1;
}
# 133 "ornek5.c"
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) (tutucu) )->sn = 139; case 139:; if(!(!(uckuyrukBos(&kuyruk2)))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (1000 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 160; case 160:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 162; case 162: return 2; } return 1;
}
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 205; case 205:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 212; case 212:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 220; case 220:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 228; case 228:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
