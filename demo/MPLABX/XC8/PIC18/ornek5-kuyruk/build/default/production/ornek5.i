...
# 348 "../../../../../kaynak/include/gorev.h"
void grvTikKesmeIsleyici(void);
# 359 "../../../../../kaynak/include/gorev.h"
...
# 32 "ornek5.c" 2
# 1 "../../../../../kaynak/include/bayrak.h" 1
# 41 "../../../../../kaynak/include/bayrak.h"
typedef struct{
 unsigned char sayim;
} bayrak_t;
# 33 "ornek5.c" 2
...
char uretici1(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
    ...
    for(;;) {
        ...
        ( (gorev_t*) tutucu )->sn = 61; case 61:; if((uckuyrukDolu(&kuyruk1))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 63; case 63:; if((uckuyrukCokluKuyrukla(&kuyruk1, veri1, 4) == 0)){ return 0; };


        do{ ( (gorev_t*) tutucu )->sn = 66; case 66:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) tutucu )->sn = 68; case 68:; if((uckuyrukDolu(&kuyruk2))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 70; case 70:; if((uckuyrukCokluKuyrukla(&kuyruk2, veri1, 4) == 0)){ return 0; };


        ++(&kuyruk2Erisim)->sayim;;


        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 76; case 76:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 79; case 79: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
# 91 "ornek5.c"
char uretici2(gorevTutucu_t tutucu) {

    unsigned char veri2[4];
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;

    for(;;) {

        ( (gorev_t*) tutucu )->sn = 98; case 98:; if((uckuyrukBos(&kuyruk1))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 100; case 100:; if((uckuyrukCokluAl(&kuyruk1, veri2, 4) == 0)){ return 0; };
        ...
        do{ ( (gorev_t*) tutucu )->sn = 107; case 107:; if(!((&kuyruk2Erisim)->sayim > 0)){ return 0; }; --(&kuyruk2Erisim)->sayim; } while(0);

        ( (gorev_t*) tutucu )->sn = 109; case 109:; if((uckuyrukDolu(&kuyruk2))){ return 0; };

        ( (gorev_t*) tutucu )->sn = 111; case 111:; if((uckuyrukCokluKuyrukla(&kuyruk2, veri2, 4) == 0)){ return 0; };


        ++(&kuyruk2Erisim)->sayim;;


        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 117; case 117:; if(VAZGECIS_BAYRAGI == 0){ return 3; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 120; case 120: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
# 130 "ornek5.c"
char gostergeDegerleriGuncelle(gorevTutucu_t tutucu) {
    ...
    static sure_t s2;
    while(1){
        ( (gorev_t*) tutucu )->sn = 136; case 136:; if((uckuyrukBos(&kuyruk2))){ return 0; };
        ...
        ( (sure_t*) &s2 )->kacTik = (1000 / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 157; case 157:; if(!(( (grvTikSayiminiAl() - ((sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
    }
...
char gostergeTara(gorevTutucu_t tutucu) {
    ...
    while(1){
        ...
        LATBbits.LATB0 = 1;
        ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 202; case 202:; if(!(( (grvTikSayiminiAl() - ((sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        if( (gosterge[3] != 0 || gosterge[2] != 0) || gosterge[1] != 0){
            ...
            LATBbits.LATB1 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 209; case 209:; if(!(( (grvTikSayiminiAl() - ((sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0 || gosterge[2] != 0){
            ...
            LATBbits.LATB2 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 217; case 217:; if(!(( (grvTikSayiminiAl() - ((sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }
        ...
        if(gosterge[3] != 0){
            ...
            LATBbits.LATB3 = 1;
            ( (sure_t*) &s5 )->kacTik = (5u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 225; case 225:; if(!(( (grvTikSayiminiAl() - ((sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        }

    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 230; case 230: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
