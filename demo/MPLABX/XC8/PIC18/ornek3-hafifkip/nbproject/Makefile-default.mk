...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=interrupt.c sistimer.c osilator.c devcfg.c ../../../../../kaynak/portlar/mplabx/xc8/pic18/port.c ../../../../../kaynak/gorev.c ornek3.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/interrupt.p1 ${OBJECTDIR}/sistimer.p1 ${OBJECTDIR}/osilator.p1 ${OBJECTDIR}/devcfg.p1 ${OBJECTDIR}/_ext/1068371252/port.p1 ${OBJECTDIR}/_ext/576648260/gorev.p1 ${OBJECTDIR}/ornek3.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/interrupt.p1.d ${OBJECTDIR}/sistimer.p1.d ${OBJECTDIR}/osilator.p1.d ${OBJECTDIR}/devcfg.p1.d ${OBJECTDIR}/_ext/1068371252/port.p1.d ${OBJECTDIR}/_ext/576648260/gorev.p1.d ${OBJECTDIR}/ornek3.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/interrupt.p1 ${OBJECTDIR}/sistimer.p1 ${OBJECTDIR}/osilator.p1 ${OBJECTDIR}/devcfg.p1 ${OBJECTDIR}/_ext/1068371252/port.p1 ${OBJECTDIR}/_ext/576648260/gorev.p1 ${OBJECTDIR}/ornek3.p1

# Source Files
SOURCEFILES=interrupt.c sistimer.c osilator.c devcfg.c ../../../../../kaynak/portlar/mplabx/xc8/pic18/port.c ../../../../../kaynak/gorev.c ornek3.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/ornek3.p1: ornek3.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ornek3.p1.d 
	@${RM} ${OBJECTDIR}/ornek3.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"." -I"../../../../../kaynak/include" -I"../../../../../kaynak/portlar/mplabx/xc8/pic18" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ornek3.p1 ornek3.c 
	@-${MV} ${OBJECTDIR}/ornek3.d ${OBJECTDIR}/ornek3.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ornek3.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"." -I"../../../../../kaynak/include" -I"../../../../../kaynak/portlar/mplabx/xc8/pic18" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"." -I"../../../../../kaynak/include" -I"../../../../../kaynak/portlar/mplabx/xc8/pic18" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ornek3-hafifkip.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
