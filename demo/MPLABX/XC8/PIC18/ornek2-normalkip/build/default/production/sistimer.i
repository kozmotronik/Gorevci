...
void sisTimerKesmeIsleyici(void){
    ...
    TMR0 = (uint16_t) ((uint16_t)((65536)-((( (1000) - ( ( ( 52 ) * ( ( 1 * ( 100 ) ) / ( (16000000 / 4 ) / 1000000 ) ) ) / ( 100 ) ) )* (16000000/1000000))/(4*(1)))-1));
...
# 154 "sistimer.c"
    ...
    sisTimerDisIsleyici = isleyici == ((void*)0) ? sisTimerIsleyiciVarsayilan : isleyici;
