...
# 32 "../../../../../kaynak/include/gorev.h" 2
# 1 "./gorevciypl.h" 1
# 33 "../../../../../kaynak/include/gorev.h" 2
# 60 "../../../../../kaynak/include/gorev.h"
typedef void *gorevTutucu_t;
typedef char (*is_t)(gorevTutucu_t);
# 70 "../../../../../kaynak/include/gorev.h"
typedef struct{
 sn_t sn;
    is_t is;
} gorev_t;
# 86 "../../../../../kaynak/include/gorev.h"
typedef struct{
 unsigned int baslangic;
 unsigned int kacTik;
} sure_t;
# 103 "../../../../../kaynak/include/gorev.h"
unsigned int tikSayiminiAl(void);
# 299 "../../../../../kaynak/include/gorev.h"
void sisTikKesmeIsleyici(void);
# 310 "../../../../../kaynak/include/gorev.h"
...
# 31 "../../../../../kaynak/portlar/mplabx/xc8/pic18/port.h"
...
char ledCakarlama1(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 107; case 107:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

        PORTBbits.RB1 = !PORTBbits.RB1;

        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 111; case 111:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 115; case 115: return 2; } return 1;
}
...
char ledCakarlama2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
  ...
  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 137; case 137:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 141; case 141:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 145; case 145:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 149; case 149:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 153; case 153:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (1000u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 157; case 157:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 160; case 160: return 2; } return 1;
}
# 170 "ornek2.c"
char karaSimsek(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (gorev_t*) tutucu )->sn = 183; case 183:; if(!(icerik == 10)){ return 0; };
        if(sola){
            karasimsek <<= 1;
  ...
  ( (sure_t*) &s3 )->kacTik = (karaSimsekHizi / (1000u / 1000u)); ( (sure_t*) &s3 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 198; case 198:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s3 )->baslangic) >= ( (sure_t*) &s3 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 201; case 201: return 2; } return 1;
}
...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
    ...
    for(;;){
        ...
        ( (gorev_t*) (tutucu) )->sn = 226; case 226:; if(!(!((ADCON0bits.GO)))){ return 0; };
        ...
        ( (sure_t*) &s4 )->kacTik = (500u / (1000u / 1000u)); ( (sure_t*) &s4 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 243; case 243:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s4 )->baslangic) >= ( (sure_t*) &s4 )->kacTik ))){ return 0; };
    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 246; case 246: return 2; } return 1;
}
...
char gostergeDegeriHesapla(gorevTutucu_t tutucu){
    ...
    while(1){
        ...
        ( (gorev_t*) tutucu )->sn = 253; case 253:; if(!(icerik == 20)){ return 0; };
    ...
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 259; case 259: return 2; } return 1;
}
...
# 272 "ornek2.c"
    ...
    while(1){
        ( (gorev_t*) tutucu )->sn = 281; case 281:; if(!(icerikDegisti == 1)){ return 0; };
        icerikDegisti = 0;
        if(icerik == 10){
            LATD = karasimsek;
        } else if(icerik == 20){
    ...
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 299; case 299: return 2; } return 1;
}
...
char icerikDegistirici(gorevTutucu_t tutucu){
    ...
    while(1){
        ( (gorev_t*) tutucu )->sn = 313; case 313:; if(!(PORTBbits.RB4 == 0)){ return 0; };
        ( (sure_t*) &s5 )->kacTik = (100u / (1000u / 1000u)); ( (sure_t*) &s5 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 314; case 314:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s5 )->baslangic) >= ( (sure_t*) &s5 )->kacTik ))){ return 0; };
        ...
        ( (gorev_t*) (tutucu) )->sn = 324; case 324:; if(!(!(PORTBbits.RB4 == 0))){ return 0; };
    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 327; case 327: return 2; } return 1;
}
...
void main(void) {
    ...
    gorevOlustur(gostergeDegeriHesapla);
    gorevOlustur(icerikGuncelleyici);
    gorevOlustur(icerikDegistirici);
