...
char ledCakarlama1(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 96; case 96:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 100; case 100: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char ledCakarlama2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
  ...
  ( (sure_t*) &s2 )->kacTik = (1000u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 144; case 144:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 147; case 147: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
# 157 "ornek1.c"
char karaSimsek(gorevTutucu_t tutucu) {
 ...
 for(;;) {
  ...
  ( (sure_t*) &s3 )->kacTik = (karaSimsekHizi / (1000u / 1000u)); ( (sure_t*) &s3 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 190; case 190:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s3 )->baslangic) >= ( (sure_t*) &s3 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 193; case 193: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
    ...
    for(;;){
        ...
        ( (gorev_t*) tutucu )->sn = 220; case 220:; if(((ADCON0bits.GO))){ return 0; };
        ...
        ( (sure_t*) &s4 )->kacTik = (350 / (1000u / 1000u)); ( (sure_t*) &s4 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 236; case 236:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s4 )->baslangic) >= ( (sure_t*) &s4 )->kacTik ))){ return 0; };
    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 239; case 239: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
