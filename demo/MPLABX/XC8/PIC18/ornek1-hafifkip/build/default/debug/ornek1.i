...
# 47 "../../../../../kaynak/portlar/mplabx/xc8/pic18/portmacro.h"
static unsigned char intconYedek;
# 32 "../../../../../kaynak/include/gorev.h" 2
# 57 "../../../../../kaynak/include/gorev.h"
...
# 94 "../../../../../kaynak/include/gorev.h"
unsigned int tikSayiminiAl(void);
# 294 "../../../../../kaynak/include/gorev.h"
...
char ledCakarlama1(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000 / 1000u)); ( (sure_t*) &s1 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 94; case 94:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

        PORTBbits.RB1 = !PORTBbits.RB1;


        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000 / 1000u)); ( (sure_t*) &s1 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 99; case 99:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };
...
char ledCakarlama2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
  ...
  ( (sure_t*) &s2 )->kacTik = (50u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 127; case 127:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 131; case 131:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 135; case 135:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 139; case 139:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 143; case 143:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (1000u / (1000 / 1000u)); ( (sure_t*) &s2 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 147; case 147:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
 }
 ...
 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 154; case 154: return 2; } return 1;
}
...
char karaSimsek(gorevTutucu_t tutucu) {
 ...
 for(;;) {
  ...
  ( (sure_t*) &s3 )->kacTik = (karaSimsekHizi / (1000 / 1000u)); ( (sure_t*) &s3 )->baslangic = tikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 197; case 197:; if(!(( (tikSayiminiAl() - ( (sure_t*) &s3 )->baslangic) >= ( (sure_t*) &s3 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 200; case 200: return 2; } return 1;
}
...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
    ...
    for(;;){
        ...
        VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 227; case 227: if((VAZGECIS_BAYRAGI) == 0 || !(dummy == 1)){ return 3; };
        dummy = 0;
    ...
    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 247; case 247: return 2; } return 1;
}
