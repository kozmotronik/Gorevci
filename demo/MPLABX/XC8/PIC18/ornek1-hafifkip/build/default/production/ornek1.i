...
char ledCakarlama1(gorevTutucu_t tutucu) {
 ...
 for(;;) {
        ...
        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 93; case 93:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

        PORTBbits.RB1 = !PORTBbits.RB1;


        ( (sure_t*) &s1 )->kacTik = (sureler[secici] / (1000u / 1000u)); ( (sure_t*) &s1 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 98; case 98:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s1 )->baslangic) >= ( (sure_t*) &s1 )->kacTik ))){ return 0; };

 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 102; case 102: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char ledCakarlama2(gorevTutucu_t tutucu) {
 ...
 char VAZGECIS_BAYRAGI = 1; switch(( (gorev_t*) tutucu )->sn) { case 0:;
  ...
  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 126; case 126:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 130; case 130:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 134; case 134:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 138; case 138:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (50u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 142; case 142:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };

        PORTBbits.RB5 = !PORTBbits.RB5;

  ( (sure_t*) &s2 )->kacTik = (1000u / (1000u / 1000u)); ( (sure_t*) &s2 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 146; case 146:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s2 )->baslangic) >= ( (sure_t*) &s2 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 149; case 149: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
# 159 "ornek1.c"
char karaSimsek(gorevTutucu_t tutucu) {
 ...
 for(;;) {
  ...
  ( (sure_t*) &s3 )->kacTik = (karaSimsekHizi / (1000u / 1000u)); ( (sure_t*) &s3 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 192; case 192:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s3 )->baslangic) >= ( (sure_t*) &s3 )->kacTik ))){ return 0; };
 }

 VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 195; case 195: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
...
char karaSimsekHiziOkuma(gorevTutucu_t tutucu){
    ...
    for(;;){
        ...
        ( (gorev_t*) tutucu )->sn = 222; case 222:; if(((ADCON0bits.GO))){ return 0; };
        ...
        ( (sure_t*) &s4 )->kacTik = (350 / (1000u / 1000u)); ( (sure_t*) &s4 )->baslangic = grvTikSayiminiAl(); ( (gorev_t*) tutucu )->sn = 238; case 238:; if(!(( (grvTikSayiminiAl() - ( (sure_t*) &s4 )->baslangic) >= ( (sure_t*) &s4 )->kacTik ))){ return 0; };
    }

    VAZGECIS_BAYRAGI = 0; ( (gorev_t*) tutucu )->sn = 241; case 241: return 2; default: ( (gorev_t*) (tutucu) )->sn = 0; return 0; } return 1;
}
